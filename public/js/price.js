...
let products = JSON.parse(loadURL('/json/products.json'));
...
for (let i = 0; i < gameLength; i++) {
    ...
    gameBlock[i].getElementsByTagName('img')[0].setAttribute('src', 'img/product-' + products[random[i]][1].id + '.png');
}

//discounts

let discount = JSON.parse(loadURL('/json/discount.json'));
