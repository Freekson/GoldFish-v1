...
<body>
    ...
    <main class="main user-settings">
        <div class="main__wrapper">
            <p class="nav"> <a href="index.php">Main</a> > <a href="personal-account.php">Personal account</a> > <a href="personal-account.php" class="active-menu__item">User Settings</a> </p>
            ...
            <section class="main__user-settings">
                <div class="user-settings__wrapper">
                    <aside class="user-setting__menu">
                        <ul>
                            <li><a href="personal-account.php">Profile</a></li>
                            <li><a href="user-orders.php">Orders</a></li>
                            <li><a href="user-events.php">Events</a></li>
                            <li><a href="user-settings.php" class="active-item">Settings</a></li>
                        </ul>
                    </aside>
