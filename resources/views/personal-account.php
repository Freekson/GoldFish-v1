...
<body>
    ...
    <main class="main personal-account">
        <div class="main__wrapper">
            <p class="nav"> <a href="index.php">Main</a> > <a href="personal-account.php">Personal account</a> > <a href="personal-account.php" class="active-menu__item">Profile</a> </p>
            ...
            <section class="main__personal-account">
                <div class="personal-account__wrapper">
                    <aside class="personal-account__menu">
                        <ul>
                            <li><a href="personal-account.php" class="active-item">Profile</a></li>
                        ...
                        <section class="user-information">
                            <div class="user-section">
                                <div class="user">
                                    ...
                                    <p class="user-name">William Harris</p>
                                </div>
                            ...
                            <div class="user__items">
                                <div class="slider__item">
                                    ...
                                    <div class="slider__buttons-block">
                                        ...
                                        <a href="ordering.php" class="buy">Buy in 1 click</a>
                                    </div>
                                </div>
                                <div class="slider__item">
                                    <img src="/img/product-1.png" alt="not found">
