            ...
            <section class="main__slider slider hurry-up">
                <div class="slider__item">
                    ...
                    <div class="slider__item_text">
                        ...
                        <p class="description">
                            40,000: <br> Chaos Space Marines
                        </p>
                    </div>
                    <p class="price ">3657 ₽</p>
                ...
                <div class="slider__item">
                    ...
                    <div class="slider__item_text">
                        ...
                        <p class="description">
                            Broken Realms: Horrek's <br> Dreadlance
                        </p>
                    </div>
                    <p class="price">3657 ₽</p>
                    <div class="slider__buttons-block">
                ...
                <div class="slider__item">
                    ...
                    <div class="slider__item_text">
                        ...
                        <p class="description">
                            Orks: Ghazghkull Thraka <br> Collector's Edition
                        </p>
                    </div>
                    <p class="price">3657 ₽</p>
                    <div class="slider__buttons-block">
            ...
            <section class="main__slider slider special-offer">
                ...
                <div class="slider__item">
                    ...
                    <div class="slider__item_text">
                        ...
                        <p class="description">
                            Gravity Falls: Save the Waddles
                        </p>
                    </div>
                    <p class="price old-price">4350 ₽</p>
                    <p class="new-price">3657 ₽</p>
