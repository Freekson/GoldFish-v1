...
@section('content')
    ...
    <main class="main personal-account">
        <div class="main__wrapper">
            <p class="nav"> <a href="{{route('index')}}">Main</a> > <a href="{{route('profile')}}">Personal account</a> > <a href="{{route('profile')}}" class="active-menu__item">Profile</a> </p>
            ...
            <section class="main__personal-account">
                <div class="personal-account__wrapper">
                    <aside class="personal-account__menu">
                        <ul>
                            <li><a href="{{route('profile')}}" class="active-item">Profile</a></li>
