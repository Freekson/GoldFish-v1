...
<body>
    ...
    <main class="main personal-account">
        <div class="main__wrapper">
            <p class="nav"> <a href="/">Main</a> > <a href="personal-account">Personal account</a> > <a href="personal-account" class="active-menu__item">Profile</a> </p>
            ...
            <section class="main__personal-account">
                <div class="personal-account__wrapper">
                    <aside class="personal-account__menu">
                        <ul>
                            <li><a href="personal-account" class="active-item">Profile</a></li>
                            ...
                            <div class="user__items">
                                <div class="slider__item">
                                    ...
                                    <div class="slider__buttons-block">
                                        ...
                                        <a href="ordering" class="buy">Buy in 1 click</a>
                                    </div>
                                </div>
                                <div class="slider__item">
                                    <img src="/img/product-1.png" alt="not found">
