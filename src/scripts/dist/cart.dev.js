...
if (document.getElementsByClassName('cart') != null && document.getElementById('cart')) {
  ...
  var counter = document.getElementById('cart');
  ...
  elements[0].onclick = function () {
    ...
    var activeItems = document.getElementsByClassName('active-cart');
    var amount = activeItems.length;
...
if (document.getElementsByClassName('cart__item') != null) {
  ...
  (function () {
    ...
    var _loop = function _loop(i) {
      var plus = cartItem[i].querySelector('.plus');
      var minus = cartItem[i].querySelector('.minus');
      var amount = cartItem[i].querySelector('.amount');
      var price = parseInt(cartItem[i].querySelector('.price').innerHTML);
      arr[i] = price;
      ...
      var clean = cartItem[i].querySelector('.clean');
    ...
    var promocodes = JSON.parse(loadURL('src/scripts/json/promocodes.json'));
    promocodes = Object.entries(promocodes);
    var promoLenght = promocodes.length; //promocodes section
    ...
    document.querySelector('.btn').onclick = function () {
      ...
      for (var _i = 0; _i < promoLenght; _i++) {
        newArr = promocodes[_i];
        var discount = parseInt(newArr[1]);
